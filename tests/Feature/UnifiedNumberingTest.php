...
/**
 * Stage 70, Track K — [D] Appendix 15's unified numbering, and the قيد moving
 * from intake to the post-completeness point Art. 20 actually names.
 *
...
class UnifiedNumberingTest extends TestCase
{
     ...
     * reference appears on the hop that establishes completeness, in
     * Appendix 15's own shape.
     */
    public function test_the_reference_is_granted_at_the_completeness_check_not_at_intake(): void
    {
        ...
        // checked — the distinction Stage 70 restored.
        ...
        // Art. 20's قيد, and Art. 38's code 06 — "اكتملت المتطلبات ومنحت رقمًا
    ...
    public function test_the_reference_series_increments_across_requests(): void
    {
        ...
        foreach ([1, 2, 3] as $sequence) {
            $requestRecord = $this->requestAt('requirements_check', 'in_review');
            $service->transition($requestRecord, 'approve', $reviewer, signaturePath: "signatures/{$sequence}.png");
