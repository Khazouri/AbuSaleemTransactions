...
/**
 * MEETING_TRANSACTIONS — the agenda: which transactions are on a meeting's
 ...
 * one transaction, which is cheap at meeting-agenda scale (a handful of
 * items, not thousands).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('meeting_transactions', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['meeting_id', 'transaction_id']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('meeting_transactions');
    }
};
