...
class EmployeeNoticeService
{
     ...
     *    none), but a file returned on `return_missing_docs` re-walks the
     *    chain and reaches `registered` again — which is literally moment 3,
     *    the completeness re-check passing.
