...
.tile-value { color: var(--color-nav); font-size: 1.6rem; line-height: 1.1; }
...
.bar-fill { display: block; block-size: 100%; border-radius: var(--radius-full); background: var(--color-nav); }
.bar-fill.nav { background: var(--color-nav); }
...
.key.created, .column.created { background: var(--color-nav); }
