        ...
        <div class="main-column">
          <section class="card description">
            ...
            <!-- Stage 90 — [G]'s «الأسباب», stated separately from the
                 description it used to fold into, so the officer reading the
                 file can tell what is being asked for from why. -->
