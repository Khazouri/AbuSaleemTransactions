...
.index-link.active { background: var(--color-surface-hover); color: var(--color-brand-text); font-weight: 600; }
...
.reader-head h3 { margin: 0; color: var(--color-brand-text); font-size: 1.05rem; }
