...
.ghost.danger { color: var(--color-red, #b91c1c); border-color: #fecaca; }
...
.notice.success { border-color: #86efac; color: #15803d; background: #f0fdf4; }
...
.error { display: block; color: #b91c1c; font-size: .72rem; }
