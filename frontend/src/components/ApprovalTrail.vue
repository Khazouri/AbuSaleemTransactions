<script setup>
/** Stage 19 — signed, chronological approval evidence for one transaction. */
...
<style scoped>
.approval-trail { padding: 1.1rem; }.approval-trail h3 { margin: 0 0 .75rem; color: var(--color-nav); font-size: 1rem; }.approval-trail ol { display: grid; gap: .75rem; padding: 0; margin: 0; list-style: none; }.approval-trail li { display: grid; grid-template-columns: 2rem minmax(0, 1fr); gap: .7rem; padding-bottom: .75rem; border-bottom: 1px solid var(--color-border); }.approval-trail li:last-child { padding-bottom: 0; border-bottom: 0; }.level { display: grid; place-items: center; align-self: start; inline-size: 2rem; block-size: 2rem; border-radius: 50%; color: #fff; background: var(--color-nav); font-size: .8rem; font-weight: 700; }.approval-copy { display: grid; gap: .25rem; min-inline-size: 0; }.approval-copy strong { color: var(--color-black-700); font-size: .88rem; }.approval-copy small, .signature-state, .state { color: var(--color-muted); font-size: .76rem; }.approval-copy p { margin: .2rem 0; color: var(--color-black-700); font-size: .82rem; white-space: pre-wrap; }.approval-copy img { display: block; inline-size: min(18rem, 100%); block-size: 6rem; margin-top: .25rem; border: 1px solid var(--color-border); border-radius: var(--radius-lg); background: #fff; object-fit: contain; }
</style>
