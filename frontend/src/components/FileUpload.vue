...
async function upload() {
  ...
  if (props.requireSection) form.append('file_section', fileSection.value)
...
<template>
  <form class="file-upload" @submit.prevent="upload">
    ...
    <p v-if="requireSection" class="hint">{{ t('attachments.fileSectionHint') }}</p>
    ...
    <button class="primary" type="submit" :disabled="uploading || !file || (requireSection && !fileSection)">
